...
public class UpdateFilmView extends GridPane {
	private final Label selectTitleLabel, libraryLabel, filmRackNrLabel, genreLabel, titleLabel, filmNrLabel,
			directorLabel, releaseDateLabel, actorLabel, errorLabel;
	private final TextField titleTextField, filmNrTextField, directorTextField, releaseDateTextField;
	...
	public UpdateFilmView(Pane mainPane) {
		...
		Label[] labelObjects = { selectTitleLabel, libraryLabel, filmRackNrLabel, genreLabel, titleLabel, filmNrLabel,
				directorLabel, releaseDateLabel, actorLabel };
		for (int i = 0; i < labelObjects.length; i++) {
			this.add(labelObjects[i], 0, i + 1);
		}

		// Place textfieldobjects with for loop
		TextField[] textFieldObjects = { titleTextField, filmNrTextField, directorTextField, releaseDateTextField };
